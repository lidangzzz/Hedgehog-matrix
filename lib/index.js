...
function _typeof(obj) { "@babel/helpers - typeof"; if (function (_left84, _right84) { if (_left84 !== null && _left84 !== undefined && _left84[Symbol.for("===")]) return _left84[Symbol.for("===")](_right84);else return _left84 === _right84; }(typeof Symbol, "function") && function (_left85, _right85) { if (_left85 !== null && _left85 !== undefined && _left85[Symbol.for("===")]) return _left85[Symbol.for("===")](_right85);else return _left85 === _right85; }(typeof Symbol.iterator, "symbol")) { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && function (_left86, _right86) { if (_left86 !== null && _left86 !== undefined && _left86[Symbol.for("===")]) return _left86[Symbol.for("===")](_right86);else return _left86 === _right86; }(typeof Symbol, "function") && function (_left87, _right87) { if (_left87 !== null && _left87 !== undefined && _left87[Symbol.for("===")]) return _left87[Symbol.for("===")](_right87);else return _left87 === _right87; }(obj.constructor, Symbol) && function (_left88, _right88) { if (_left88 !== null && _left88 !== undefined && _left88[Symbol.for("!==")]) return _left88[Symbol.for("!==")](_right88);else return _left88 !== _right88; }(obj, Symbol.prototype) ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _classCallCheck(instance, Constructor) { if (!function (_left83, _right83) { if (_left83 !== null && _left83 !== undefined && _left83[Symbol.for("instanceof")]) return _left83[Symbol.for("instanceof")](_right83);else return _left83 instanceof _right83; }(instance, Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function _defineProperties(target, props) { for (var i = 0; function (_left81, _right81) { if (_left81 !== null && _left81 !== undefined && _left81[Symbol.for("<")]) return _left81[Symbol.for("<")](_right81);else return _left81 < _right81; }(i, props.length); i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (function (_left82, _right82) { if (_left82 !== null && _left82 !== undefined && _left82[Symbol.for("in")]) return _left82[Symbol.for("in")](_right82);else return _left82 in _right82; }("value", descriptor)) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var Mat = /*#__PURE__*/function () {
  ...
  _createClass(Mat, [{
    ...
    value: function value(rightOperand) {
      ...
      if (!Number.isInteger(rightOperand) || function (_left42, _right42) {
      ...
      for (var i = 2; function (_left43, _right43) {
    ...
    value: function value(rightOperand) {
      ...
      if (Array.isArray(rightOperand)) {
        ...
        return this.equals(rightOperandMatrix);
          ...
          }(this.val[0][0], rightOperand), function (_left52, _right52) {
    ...
    value: function col(colIndex) {
      ...
      for (var rowPt = 0; function (_left53, _right53) {
    ...
    value: function columnVector(col) {
      ...
      for (var i = 0; function (_left74, _right74) {
    ...
    value: function squareSum() {
      ...
      for (var i = 0; function (_left75, _right75) {
        ...
        for (var j = 0; function (_left76, _right76) {
...
function _mul(leftMat, rightMat) {
  if (function (_left100, _right100) {
  ...
  for (var i = 0; function (_left101, _right101) {
    ...
    for (var j = 0; function (_left102, _right102) {
      ...
      for (var it = 0; function (_left103, _right103) {
        ...
        val += function (_left104, _right104) {
...
function dotMulInPlace(leftMat, rightMat) {
  if (function (_left105, _right105) {
  ...
  }(leftMat.rows, rightMat.rows) || function (_left106, _right106) {
  ...
  for (var i = 0; function (_left107, _right107) {
    ...
    for (var j = 0; function (_left108, _right108) {
...
function mat2csv(A) {
  ...
  for (var i = 0; function (_left109, _right109) {
    ...
    for (var j = 0; function (_left110, _right110) {
      ...
      if (function (_left111, _right111) {
        ...
        returnCSV += function (_left112, _right112) {
...
function csv2mat(strCSV) {
  ...
  try {
    if (function (_left113, _right113) {
    ...
    var linesOfCSVString = split_result.filter(function (x) {
      return function (_left114, _right114) {
    ...
    for (var row = 0; function (_left115, _right115) {
      ...
      if (function (_left116, _right116) {
      ...
      }(listOfElement.length, cols)) throw new Error(function (_left117, _right117) {
      ...
      for (var col = 0; function (_left119, _right119) {
    ...
    throw new Error(function (_left120, _right120) {
...
function json2mat(json_str) {
  ...
  if (function (_left121, _right121) {
  ...
  }(A.rows, obj.rows) && function (_left122, _right122) {
...
var b = function (_left123, _right123) {
...
var d = function (_left124, _right124) {
